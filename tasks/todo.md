...
- [x] Publish changes through GitHub Git Data API, not local git push.
...
- [x] Run ruff, strict mypy, full pytest with coverage threshold, package build, and CLI smoke checks.
- [x] Run adversarial verification against the remote branch artifact.
